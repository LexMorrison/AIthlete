...
const GenerateProgramPage = () => {
  ...
  useEffect(() => {
    ...
    const handleSpeachStart = () => {
      console.log("AI started speaking");
      setIsSpeaking(true);
    };

    const handleSpeachEnd = () => {
    ...
    vapi
      ...
      .on("speech-start", handleSpeachStart)
      .on("speech-end", handleSpeachEnd)
    ...
    return () => {
      vapi
        ...
        .off("speech-start", handleSpeachStart)
        .off("speech-end", handleSpeachEnd)
    ...
    if (callActive) vapi.stop();
      ...
      try {
        ...
        await vapi.start(process.env.NEXT_PUBLIC_VAPI_WORKFLOW_ID!, {
          variableValues: { full_name: fullName, user_id: user?.id },
        });
      } catch (error) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <Card className="bg-card/90 backdrop-blur-sm border border-border overflow-hidden relative">
            <div className="aspect-video flex flex-col items-center justify-center p-6 relative">
              ...
              <h2 className="text-xl font-bold text-foreground">AIthlete AI</h2>
              ...
              {messages.map((msg, index) => (
                <div key={index} className="message-item animate-fadeIn">
                  <div className="font-semibold text-xs text-muted-foreground mb-1">
                    {msg.role === "assistant" ? "AIthlete AI" : "You"}:
                  </div>
